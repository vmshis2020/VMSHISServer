...
namespace  VNS.HIS.UI.THANHTOAN
{
    public partial class frm_THANHTOAN_NOITRU : Form
    {
        ...
        #endregion
        public frm_THANHTOAN_NOITRU(string Args)
        {
            InitializeComponent();
            KeyPreview = true;
            this.Args = Args;
        ...
        void InitEvents()
        {
            Load += new EventHandler(frm_THANHTOAN_NOITRU_Load);
            FormClosing += new FormClosingEventHandler(frm_THANHTOAN_NOITRU_FormClosing);
            KeyDown += new KeyEventHandler(frm_THANHTOAN_NOITRU_KeyDown);
        ...
        private void ModifyCommand()
        {
            try
            {
                ...
                cmdInphoiBHYT.Visible = Utility.isValidGrid(grdList) && Chuathanhtoan <= 0 && Utility.DecimaltoDbnull(txtSoTienCanNop.Text) <= 0 && objLuotkham.MaDoituongKcb == "BHYT" && grdPayment.GetDataRows().Length > 0 && objLuotkham != null;
        ...
        private void frm_THANHTOAN_NOITRU_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_THANHTOAN_NOITRU_FormClosing(object sender, FormClosingEventArgs e)
        {
