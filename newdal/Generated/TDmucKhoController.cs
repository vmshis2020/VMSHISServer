...
namespace VNS.HIS.DAL
{
    ...
    public partial class TDmucKhoController
    {
	    ...
	    public void Insert(string MaKho,string TenKho,int? SttHthi,string KieuKho,string KhoThuocVt,byte? LoaiKho,short IdKhoaphong,string MotaThem,byte? LaQuaythuoc,byte? KtraTon,DateTime? NgaySua,DateTime? NgayTao,string NguoiSua,string NguoiTao,byte? LaTuthuoc,string LoaiBnhan,byte? TrangThai,byte? TuTuc,byte? ChophepChongia,string KieuBiendong)
	    {
