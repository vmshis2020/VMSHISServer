...
namespace VNS.HIS.DAL
{
	...
	public partial class DynamicField : ActiveRecord<DynamicField>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMa,string varMota,short? varStt,int? varIdDichvuchitiet,string varBodypart,string varViewposition,byte? varRtxt,byte? varTopLabel)
		{
		...
		/// </summary>
		public static void Update(int varId,string varMa,string varMota,short? varStt,int? varIdDichvuchitiet,string varBodypart,string varViewposition,byte? varRtxt,byte? varTopLabel)
		{
			DynamicField item = new DynamicField();
