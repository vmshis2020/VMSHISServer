	...
	public partial class KcbLuotkham : ActiveRecord<KcbLuotkham>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarSoRavien.DataType = DbType.Int32;
				colvarSoRavien.MaxLength = 0;
				...
				TableSchema.TableColumn colvarTraKQPhongchuyenmon = new TableSchema.TableColumn(schema);
				colvarTraKQPhongchuyenmon.ColumnName = "traKQ_Phongchuyenmon";
				colvarTraKQPhongchuyenmon.DataType = DbType.Byte;
				colvarTraKQPhongchuyenmon.MaxLength = 0;
				colvarTraKQPhongchuyenmon.AutoIncrement = false;
				colvarTraKQPhongchuyenmon.IsNullable = true;
				colvarTraKQPhongchuyenmon.IsPrimaryKey = false;
				colvarTraKQPhongchuyenmon.IsForeignKey = false;
				colvarTraKQPhongchuyenmon.IsReadOnly = false;
				colvarTraKQPhongchuyenmon.DefaultSetting = @"";
				colvarTraKQPhongchuyenmon.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTraKQPhongchuyenmon);
				...
				TableSchema.TableColumn colvarTraKQMail = new TableSchema.TableColumn(schema);
				colvarTraKQMail.ColumnName = "traKQ_Mail";
				colvarTraKQMail.DataType = DbType.Byte;
				colvarTraKQMail.MaxLength = 0;
				colvarTraKQMail.AutoIncrement = false;
				colvarTraKQMail.IsNullable = true;
				colvarTraKQMail.IsPrimaryKey = false;
				colvarTraKQMail.IsForeignKey = false;
				colvarTraKQMail.IsReadOnly = false;
				colvarTraKQMail.DefaultSetting = @"";
				colvarTraKQMail.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTraKQMail);
		...
		public int? SoRavien 
		{
			get { return GetColumnValue<int?>(Columns.SoRavien); }
		...
		[XmlAttribute("TraKQPhongchuyenmon")]
		[Bindable(true)]
		public byte? TraKQPhongchuyenmon 
		{
			get { return GetColumnValue<byte?>(Columns.TraKQPhongchuyenmon); }
			set { SetColumnValue(Columns.TraKQPhongchuyenmon, value); }
		}
		...
		[XmlAttribute("TraKQMail")]
		[Bindable(true)]
		public byte? TraKQMail 
		{
			get { return GetColumnValue<byte?>(Columns.TraKQMail); }
			set { SetColumnValue(Columns.TraKQMail, value); }
		}
		...
		public static void Insert(string varMaLuotkham,long varIdBenhnhan,DateTime varNgayTiepdon,string varNguoiTiepdon,int varTuoi,byte varLoaiTuoi,short varIdDoituongKcb,string varMadoituongGia,string varMaDoituongKcb,byte? varIdLoaidoituongKcb,decimal? varPtramBhytGoc,decimal? varPtramBhyt,string varMatheBhyt,DateTime? varNgaybatdauBhyt,DateTime? varNgayketthucBhyt,string varNoicapBhyt,string varMaNoicapBhyt,string varMaDoituongBhyt,int? varMaQuyenloi,string varNoiDongtrusoKcbbd,string varMaKcbbd,byte? varDungTuyen,string varCmt,DateTime? varNgayThanhtoan,decimal? varLuongCoban,int? varTrangthaiCapcuu,string varTrieuChung,string varChanDoan,string varKetLuan,string varHuongDieutri,string varMabenhChinh,string varMabenhPhu,byte varHienthiBaocao,string varSoBenhAn,int? varSongayDieutri,short? varIdKhoatiepnhan,short? varSolanKham,int? varSttKham,byte? varNoitru,string varMaKhoaThuchien,string varChandoanKemtheo,string varNguoiKetthuc,DateTime? varNgayKetthuc,string varLydoKetthuc,string varDiaChi,string varDiachiBhyt,short? varIdBenhvienDen,short? varIdBenhvienDi,byte? varTthaiChuyenden,byte? varTthaiChuyendi,short? varIdBacsiChuyenvien,byte? varTrangthaiNgoaitru,byte varTrangthaiNoitru,byte varLocked,byte? varTthaiThopNoitru,byte? varTthaiThanhtoannoitru,long? varIdNhapvien,DateTime? varNgayNhapvien,DateTime? varNgayRavien,int? varSoRavien,string varMotaNhapvien,long? varIdRavien,short? varIdKhoanoitru,short? varIdBuong,short? varIdGiuong,DateTime? varNgayKedon,DateTime? varNgayNhanthuoc,DateTime? varNgayNhanketquaCls,string varNoiGioithieu,byte? varBoVien,string varEmail,string varNhomBenhnhan,byte? varGiayBhyt,string varMadtuongSinhsong,string varIpMaytao,string varIpMaysua,string varTenMaytao,long? varIdLichsuDoituongKcb,string varTenMaysua,byte? varCachTao,string varKieuKham,byte? varTraKQPhongchuyenmon,byte? varTraKQFax,byte? varTraKQMail,byte? varTraKQEmail,byte? varSosanhQcvn,string varMotaThem,DateTime varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,string varLastActionName)
		{
			...
			item.TraKQPhongchuyenmon = varTraKQPhongchuyenmon;
			
			item.TraKQFax = varTraKQFax;
			
			item.TraKQMail = varTraKQMail;
        ...
        public static TableSchema.TableColumn TraKQPhongchuyenmonColumn
        {
        ...
        public static TableSchema.TableColumn TraKQMailColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string TraKQPhongchuyenmon = @"traKQ_Phongchuyenmon";
			 public static string TraKQFax = @"traKQ_Fax";
			 public static string TraKQMail = @"traKQ_Mail";
