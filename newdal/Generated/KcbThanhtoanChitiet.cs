...
namespace VNS.HIS.DAL
{
	...
	public partial class KcbThanhtoanChitiet : ActiveRecord<KcbThanhtoanChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long varIdThanhtoan,int varIdPhieu,int varIdPhieuChitiet,int varIdDichvu,int varIdChitietdichvu,string varTenChitietdichvu,string varMadoituongGia,decimal? varPtramBhytGoc,decimal varPtramBhyt,int varSoLuong,decimal varDonGia,decimal varBnhanChitra,decimal varBhytChitra,decimal varPhuThu,byte varTuTuc,string varTenBhyt,string varDonviTinh,int? varSttIn,int? varIdKhoakcb,short? varIdPhongkham,short? varIdBacsiChidinh,byte varIdLoaithanhtoan,string varTenLoaithanhtoan,string varMaDoituongKcb,string varKieuChietkhau,decimal? varTileChietkhau,decimal? varTienChietkhau,byte? varTrangthaiBhyt,byte? varTrangthaiChuyen,byte? varTinhChiphi,byte varNoiTru,int? varIdGoi,byte? varTrongGoi,long? varIdKham,byte? varNguonGoc,long? varIdThanhtoanhuy,byte? varTrangthaiHuy,long? varIdLichsuDoituongKcb,string varMatheBhyt,DateTime varNgayTao,string varNguoiTao)
		{
		...
		/// </summary>
		public static void Update(long varIdChitiet,long varIdThanhtoan,int varIdPhieu,int varIdPhieuChitiet,int varIdDichvu,int varIdChitietdichvu,string varTenChitietdichvu,string varMadoituongGia,decimal? varPtramBhytGoc,decimal varPtramBhyt,int varSoLuong,decimal varDonGia,decimal varBnhanChitra,decimal varBhytChitra,decimal varPhuThu,byte varTuTuc,string varTenBhyt,string varDonviTinh,int? varSttIn,int? varIdKhoakcb,short? varIdPhongkham,short? varIdBacsiChidinh,byte varIdLoaithanhtoan,string varTenLoaithanhtoan,string varMaDoituongKcb,string varKieuChietkhau,decimal? varTileChietkhau,decimal? varTienChietkhau,byte? varTrangthaiBhyt,byte? varTrangthaiChuyen,byte? varTinhChiphi,byte varNoiTru,int? varIdGoi,byte? varTrongGoi,long? varIdKham,byte? varNguonGoc,long? varIdThanhtoanhuy,byte? varTrangthaiHuy,long? varIdLichsuDoituongKcb,string varMatheBhyt,DateTime varNgayTao,string varNguoiTao)
		{
			KcbThanhtoanChitiet item = new KcbThanhtoanChitiet();
