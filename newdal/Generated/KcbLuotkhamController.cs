...
namespace VNS.HIS.DAL
{
    ...
    public partial class KcbLuotkhamController
    {
	    ...
	    public void Insert(string MaLuotkham,long IdBenhnhan,DateTime NgayTiepdon,string NguoiTiepdon,int Tuoi,byte LoaiTuoi,short IdDoituongKcb,string MadoituongGia,string MaDoituongKcb,byte? IdLoaidoituongKcb,decimal? PtramBhytGoc,decimal? PtramBhyt,string MatheBhyt,DateTime? NgaybatdauBhyt,DateTime? NgayketthucBhyt,string NoicapBhyt,string MaNoicapBhyt,string MaDoituongBhyt,int? MaQuyenloi,string NoiDongtrusoKcbbd,string MaKcbbd,byte? DungTuyen,string Cmt,DateTime? NgayThanhtoan,decimal? LuongCoban,int? TrangthaiCapcuu,string TrieuChung,string ChanDoan,string KetLuan,string HuongDieutri,string MabenhChinh,string MabenhPhu,byte HienthiBaocao,string SoBenhAn,int? SongayDieutri,short? IdKhoatiepnhan,short? SolanKham,int? SttKham,byte? Noitru,string MaKhoaThuchien,string ChandoanKemtheo,string NguoiKetthuc,DateTime? NgayKetthuc,string LydoKetthuc,string DiaChi,string DiachiBhyt,short? IdBenhvienDen,short? IdBenhvienDi,byte? TthaiChuyenden,byte? TthaiChuyendi,short? IdBacsiChuyenvien,byte? TrangthaiNgoaitru,byte TrangthaiNoitru,byte Locked,byte? TthaiThopNoitru,byte? TthaiThanhtoannoitru,long? IdNhapvien,DateTime? NgayNhapvien,DateTime? NgayRavien,int? SoRavien,string MotaNhapvien,long? IdRavien,short? IdKhoanoitru,short? IdBuong,short? IdGiuong,DateTime? NgayKedon,DateTime? NgayNhanthuoc,DateTime? NgayNhanketquaCls,string NoiGioithieu,byte? BoVien,string Email,string NhomBenhnhan,byte? GiayBhyt,string MadtuongSinhsong,string IpMaytao,string IpMaysua,string TenMaytao,long? IdLichsuDoituongKcb,string TenMaysua,byte? CachTao,string KieuKham,byte? TraKQPhongchuyenmon,byte? TraKQFax,byte? TraKQMail,byte? TraKQEmail,byte? SosanhQcvn,string MotaThem,DateTime NgayTao,string NguoiTao,DateTime? NgaySua,string NguoiSua,string LastActionName)
	    {
            ...
            item.TraKQPhongchuyenmon = TraKQPhongchuyenmon;
            
            item.TraKQFax = TraKQFax;
            
            item.TraKQMail = TraKQMail;
