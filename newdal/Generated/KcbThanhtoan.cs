...
namespace VNS.HIS.DAL
{
	...
	public partial class KcbThanhtoan : ActiveRecord<KcbThanhtoan>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaThanhtoan,long varIdBenhnhan,string varMaLuotkham,string varMaDoituongKcb,short? varIdDoituongKcb,short? varIdLoaidoituongKcb,DateTime varNgayThanhtoan,int varIdNhanvienThanhtoan,byte varKieuThanhtoan,int? varTrangthaiIn,DateTime? varNgayIn,string varNguoiIn,DateTime? varNgayTonghop,string varNguoiTonghop,string varMaKhoaThuchien,DateTime? varNgayChot,byte? varTrangthaiChot,decimal varTongTien,decimal varBhytChitra,decimal varBnhanChitra,decimal? varPhuThu,decimal? varTuTuc,short? varPtramBhyt,decimal varTileChietkhau,string varKieuChietkhau,decimal varTongtienChietkhau,decimal? varTongtienChietkhauHoadon,decimal? varTongtienChietkhauChitiet,string varMaLydoChietkhau,byte varNoiTru,string varMaPttt,DateTime? varNgayRavien,string varMaLydoHuy,int? varIdCapphat,string varMauHoadon,string varKiHieu,string varMaQuyen,string varSerie,byte? varTrangthaiSeri,long? varIdHdonLog,string varNguoiTao,DateTime varNgayTao,DateTime? varNguoiSua,string varNgaySua,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua)
		{
		...
		/// </summary>
		public static void Update(long varIdThanhtoan,string varMaThanhtoan,long varIdBenhnhan,string varMaLuotkham,string varMaDoituongKcb,short? varIdDoituongKcb,short? varIdLoaidoituongKcb,DateTime varNgayThanhtoan,int varIdNhanvienThanhtoan,byte varKieuThanhtoan,int? varTrangthaiIn,DateTime? varNgayIn,string varNguoiIn,DateTime? varNgayTonghop,string varNguoiTonghop,string varMaKhoaThuchien,DateTime? varNgayChot,byte? varTrangthaiChot,decimal varTongTien,decimal varBhytChitra,decimal varBnhanChitra,decimal? varPhuThu,decimal? varTuTuc,short? varPtramBhyt,decimal varTileChietkhau,string varKieuChietkhau,decimal varTongtienChietkhau,decimal? varTongtienChietkhauHoadon,decimal? varTongtienChietkhauChitiet,string varMaLydoChietkhau,byte varNoiTru,string varMaPttt,DateTime? varNgayRavien,string varMaLydoHuy,int? varIdCapphat,string varMauHoadon,string varKiHieu,string varMaQuyen,string varSerie,byte? varTrangthaiSeri,long? varIdHdonLog,string varNguoiTao,DateTime varNgayTao,DateTime? varNguoiSua,string varNgaySua,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua)
		{
			KcbThanhtoan item = new KcbThanhtoan();
