...
{
	/// <summary>
	/// Strongly-typed collection for the DmucChitietGoikhamKiemdinh class.
	/// </summary>
    [Serializable]
	public partial class DmucChitietGoikhamKiemdinhCollection : ActiveList<DmucChitietGoikhamKiemdinh, DmucChitietGoikhamKiemdinhCollection>
	{	   
		public DmucChitietGoikhamKiemdinhCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DmucChitietGoikhamKiemdinhCollection</returns>
		public DmucChitietGoikhamKiemdinhCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                DmucChitietGoikhamKiemdinh o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the dmuc_chitiet_goikham_kiemdinh table.
	/// </summary>
	[Serializable]
	public partial class DmucChitietGoikhamKiemdinh : ActiveRecord<DmucChitietGoikhamKiemdinh>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public DmucChitietGoikhamKiemdinh()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public DmucChitietGoikhamKiemdinh(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public DmucChitietGoikhamKiemdinh(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public DmucChitietGoikhamKiemdinh(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("dmuc_chitiet_goikham_kiemdinh", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("dmuc_chitiet_goikham_kiemdinh",schema);
			}
		}
		#endregion
		...
		{
			DmucChitietGoikhamKiemdinh item = new DmucChitietGoikhamKiemdinh();
