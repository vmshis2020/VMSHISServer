...
namespace VNS.HIS.DAL
{
    ...
    public partial class KcbThanhtoanChitietController
    {
	    ...
	    public void Insert(long IdThanhtoan,int IdPhieu,int IdPhieuChitiet,int IdDichvu,int IdChitietdichvu,string TenChitietdichvu,string MadoituongGia,decimal? PtramBhytGoc,decimal PtramBhyt,int SoLuong,decimal DonGia,decimal BnhanChitra,decimal BhytChitra,decimal PhuThu,byte TuTuc,string TenBhyt,string DonviTinh,int? SttIn,int? IdKhoakcb,short? IdPhongkham,short? IdBacsiChidinh,byte IdLoaithanhtoan,string TenLoaithanhtoan,string MaDoituongKcb,string KieuChietkhau,decimal? TileChietkhau,decimal? TienChietkhau,byte? TrangthaiBhyt,byte? TrangthaiChuyen,byte? TinhChiphi,byte NoiTru,int? IdGoi,byte? TrongGoi,long? IdKham,byte? NguonGoc,long? IdThanhtoanhuy,byte? TrangthaiHuy,long? IdLichsuDoituongKcb,string MatheBhyt,DateTime NgayTao,string NguoiTao)
	    {
	    ...
	    public void Update(long IdChitiet,long IdThanhtoan,int IdPhieu,int IdPhieuChitiet,int IdDichvu,int IdChitietdichvu,string TenChitietdichvu,string MadoituongGia,decimal? PtramBhytGoc,decimal PtramBhyt,int SoLuong,decimal DonGia,decimal BnhanChitra,decimal BhytChitra,decimal PhuThu,byte TuTuc,string TenBhyt,string DonviTinh,int? SttIn,int? IdKhoakcb,short? IdPhongkham,short? IdBacsiChidinh,byte IdLoaithanhtoan,string TenLoaithanhtoan,string MaDoituongKcb,string KieuChietkhau,decimal? TileChietkhau,decimal? TienChietkhau,byte? TrangthaiBhyt,byte? TrangthaiChuyen,byte? TinhChiphi,byte NoiTru,int? IdGoi,byte? TrongGoi,long? IdKham,byte? NguonGoc,long? IdThanhtoanhuy,byte? TrangthaiHuy,long? IdLichsuDoituongKcb,string MatheBhyt,DateTime NgayTao,string NguoiTao)
	    {
		    KcbThanhtoanChitiet item = new KcbThanhtoanChitiet();
	        item.MarkOld();
	        item.IsLoaded = true;
