...
{
	/// <summary>
	/// Strongly-typed collection for the DmucGoikhamKiemdinh class.
	/// </summary>
    [Serializable]
	public partial class DmucGoikhamKiemdinhCollection : ActiveList<DmucGoikhamKiemdinh, DmucGoikhamKiemdinhCollection>
	{	   
		public DmucGoikhamKiemdinhCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DmucGoikhamKiemdinhCollection</returns>
		public DmucGoikhamKiemdinhCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                DmucGoikhamKiemdinh o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the dmuc_goikham_kiemdinh table.
	/// </summary>
	[Serializable]
	public partial class DmucGoikhamKiemdinh : ActiveRecord<DmucGoikhamKiemdinh>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public DmucGoikhamKiemdinh()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public DmucGoikhamKiemdinh(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public DmucGoikhamKiemdinh(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public DmucGoikhamKiemdinh(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("dmuc_goikham_kiemdinh", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarLagoiMaukiemdinh = new TableSchema.TableColumn(schema);
				colvarLagoiMaukiemdinh.ColumnName = "lagoi_maukiemdinh";
				colvarLagoiMaukiemdinh.DataType = DbType.Byte;
				colvarLagoiMaukiemdinh.MaxLength = 0;
				colvarLagoiMaukiemdinh.AutoIncrement = false;
				colvarLagoiMaukiemdinh.IsNullable = false;
				colvarLagoiMaukiemdinh.IsPrimaryKey = false;
				colvarLagoiMaukiemdinh.IsForeignKey = false;
				colvarLagoiMaukiemdinh.IsReadOnly = false;
				
						colvarLagoiMaukiemdinh.DefaultSetting = @"((0))";
				colvarLagoiMaukiemdinh.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLagoiMaukiemdinh);
				...
				DataService.Providers["ORM"].AddSchema("dmuc_goikham_kiemdinh",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("LagoiMaukiemdinh")]
		[Bindable(true)]
		public byte LagoiMaukiemdinh 
		{
			get { return GetColumnValue<byte>(Columns.LagoiMaukiemdinh); }
			set { SetColumnValue(Columns.LagoiMaukiemdinh, value); }
		}
		...
		/// </summary>
		public static void Insert(string varMaGoi,string varTenGoi,decimal varDonGia,string varMaloaigoi,byte varNoitru,short? varSongaySudung,byte varLagoiMaukiemdinh,string varMotathem,string varNguoiTao,DateTime varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
			...
			item.LagoiMaukiemdinh = varLagoiMaukiemdinh;
		...
		/// </summary>
		public static void Update(int varIdGoi,string varMaGoi,string varTenGoi,decimal varDonGia,string varMaloaigoi,byte varNoitru,short? varSongaySudung,byte varLagoiMaukiemdinh,string varMotathem,string varNguoiTao,DateTime varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
			DmucGoikhamKiemdinh item = new DmucGoikhamKiemdinh();
        ...
        public static TableSchema.TableColumn LagoiMaukiemdinhColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string LagoiMaukiemdinh = @"lagoi_maukiemdinh";
