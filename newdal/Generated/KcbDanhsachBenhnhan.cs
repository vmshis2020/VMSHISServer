...
namespace VNS.HIS.DAL
{
	...
	public partial class KcbDanhsachBenhnhan : ActiveRecord<KcbDanhsachBenhnhan>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varTenBenhnhan,string varDiaChi,string varMaTinhThanhpho,string varMaQuanhuyen,DateTime? varNgaySinh,short? varNamSinh,byte? varIdGioitinh,string varGioiTinh,string varNgheNghiep,string varCoQuan,string varCmt,short? varMaQuocgia,string varDienThoai,string varNguoiLienhe,string varDienthoaiLienhe,string varDiachiLienhe,string varFax,string varEmail,DateTime varNgayTiepdon,string varNguoiTiepdon,string varDanToc,string varTonGiao,DateTime? varNgaySua,DateTime? varNgayTao,string varNguoiSua,string varNguoiTao,string varDiachiBhyt,string varNguonGoc,byte? varKieuBenhnhan,byte? varMacDinh,string varSoTiemchungQg,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua,string varLastActionName)
		{
