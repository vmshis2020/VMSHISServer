...
namespace VNS.HIS.DAL
{
	...
	public partial class KcbChidinhcl : ActiveRecord<KcbChidinhcl>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long? varIdKham,long? varIdBuongGiuong,long? varIdDieutri,int? varIdKhoadieutri,long varIdBenhnhan,string varMaLuotkham,DateTime varNgayChidinh,short? varIdBacsiChidinh,short? varIdPhongChidinh,DateTime? varNgayThanhtoan,byte varTrangthaiThanhtoan,byte? varTrangThai,byte? varTinhtrangIn,string varBarcode,byte? varNoitru,short? varIdKhoaChidinh,string varMaKhoaChidinh,string varMaChidinh,string varMaBenhpham,short? varIdDoituongKcb,byte? varIdLoaidoituongKcb,string varMaDoituongKcb,byte? varKieuChidinh,long? varIdLichsuDoituongKcb,string varMatheBhyt,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua,string varNguoigiaoMau,string varNguoinhanMau,string varMotaThem,byte? varDaBangiaomau,int? varLuongmauHoaly,int? varLuongmauVisinh,int? varLuongmauGui,byte? varLuuMau,string varDieukienLuumau,byte? varThanhlyMau,DateTime? varNgayThanhly,string varNguoiThanhly,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua,string varLastActionName)
		{
