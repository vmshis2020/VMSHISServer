...
namespace VNS.HIS.DAL
{
	...
	public partial class DmucDichvuclsChitiet : ActiveRecord<DmucDichvuclsChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Update(int varIdChitietdichvu,string varMaChitietdichvu,string varMaChitietdichvuBhyt,string varTenChitietdichvu,string varTenChitietdichvuBhyt,short varIdDichvu,string varMaDonvitinh,string varBinhthuongNam,string varBinhthuongNu,byte? varTrangThai,byte? varHienThi,decimal? varDonGia,string varMotaThem,int? varSttHthi,short? varIdKhoaThuchien,short? varIdPhongThuchien,string varChiDan,string varNhomBaocao,DateTime? varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,string varMaKhoathuchien,byte? varTuTuc,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,byte? varCoChitiet,int? varIdCha,int? varIdVungkhaosat,string varBodypart,string varViewPosition,string varMauChuan,string varMauCanhan,byte? varLaChiphithem,int? varSoluongChitieu,string varMaPhuongphapthu,string varKihieuDinhtinhDat,string varIdCamchidinhchungphieu,byte? varSingleService)
		{
			DmucDichvuclsChitiet item = new DmucDichvuclsChitiet();
