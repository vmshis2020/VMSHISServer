...
namespace VNS.HIS.DAL
{
    ...
    public partial class DynamicFieldController
    {
	    ...
	    public void Insert(string Ma,string Mota,short? Stt,int? IdDichvuchitiet,string Bodypart,string Viewposition,byte? Rtxt,byte? TopLabel)
	    {
	    ...
	    public void Update(int Id,string Ma,string Mota,short? Stt,int? IdDichvuchitiet,string Bodypart,string Viewposition,byte? Rtxt,byte? TopLabel)
	    {
		    DynamicField item = new DynamicField();
	        item.MarkOld();
	        item.IsLoaded = true;
