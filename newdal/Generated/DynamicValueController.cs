...
namespace VNS.HIS.DAL
{
    ...
    public partial class DynamicValueController
    {
	    ...
	    public void Insert(string Ma,string Giatri,string Rtf,long? IdChidinhchitiet,long? ImageId)
	    {
	    ...
	    public void Update(long Id,string Ma,string Giatri,string Rtf,long? IdChidinhchitiet,long? ImageId)
	    {
		    DynamicValue item = new DynamicValue();
	        item.MarkOld();
	        item.IsLoaded = true;
