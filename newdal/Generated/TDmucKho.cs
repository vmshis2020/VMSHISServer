...
namespace VNS.HIS.DAL
{
	...
	public partial class TDmucKho : ActiveRecord<TDmucKho>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaKho,string varTenKho,int? varSttHthi,string varKieuKho,string varKhoThuocVt,byte? varLoaiKho,short varIdKhoaphong,string varMotaThem,byte? varLaQuaythuoc,byte? varKtraTon,DateTime? varNgaySua,DateTime? varNgayTao,string varNguoiSua,string varNguoiTao,byte? varLaTuthuoc,string varLoaiBnhan,byte? varTrangThai,byte? varTuTuc,byte? varChophepChongia,string varKieuBiendong)
		{
